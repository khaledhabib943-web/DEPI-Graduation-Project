...
namespace FinalProject.Infrastructure.Migrations
{
    ...
    [Migration("20260425021633_InitialCreate")]
            ...
            modelBuilder.Entity("FinalProject.Domain.Entities.Admin", b =>
                {
                    b.HasOne("FinalProject.Domain.Entities.User", null)
                        .WithOne()
                        .HasForeignKey("FinalProject.Domain.Entities.Admin", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("FinalProject.Domain.Entities.Customer", b =>
                {
                    b.HasOne("FinalProject.Domain.Entities.User", null)
                        .WithOne()
                        .HasForeignKey("FinalProject.Domain.Entities.Customer", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("FinalProject.Domain.Entities.Worker", b =>
                {
                    ...
                    b.HasOne("FinalProject.Domain.Entities.User", null)
                        .WithOne()
                        .HasForeignKey("FinalProject.Domain.Entities.Worker", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
